...
const PRODUCTS = {
    pantalon: {
        ...
        description: `
            <p>
                Pantalon confortable avec une coupe moderne
                et un style facile à porter.
            </p>
...
Texture: CASSANTS 
Conservations:
CURÉE , Emballer Comme Commander Provenance : MAROC 🇲🇦 
Qualité : ⭐️⭐️⭐️⭐️⭐️
            </p>

            <p>
                Pour connaître les tailles, les couleurs et les
                modalités de livraison disponibles, appuyez sur
                le bouton Achat immédiat.
            </p>
        `,
